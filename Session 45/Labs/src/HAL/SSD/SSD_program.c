...
void seven_segment_void_Initialize()
{
...
void seven_segment_void_write(const u8 Copy_u8val)
{
	GPIO_void_Set_Pin_Value_Atomic(DATA_PORT , DATA_BIT0 ,(Copy_u8val >> 0) & 0x01 );
